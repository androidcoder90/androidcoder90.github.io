...
## merge
	...
	git merge origin
### option
	git merge --no-commits
	git merge --squash //all changes
...
## request-pull
	...
	git request-pull origin/master <repo>

## format-path
	git format-path -M origin/master //diff commit with traced  origin/master , -M allow to check Rename Commit
